...
const programs = () => {
  return (
    <div className="py-20 w-full h-full font-serif">
      <div className="h-80 w-full bg-[#233dfc] mx-auto flex justify-center items-center">
        <h1 className="font-bold text-center text-4xl">PROGRAMS</h1>
      </div>
