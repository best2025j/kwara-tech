...
const contact = () => {
  ...
  return (
    <div id="contact" className="w-full lg:h-auto py-20">
      <div className="h-40 w-full bg-[#233dfc]  mx-auto flex justify-center items-center">
        <h1 className="font-bold text-center text-4xl uppercase">contact</h1>
      </div>
      {/*  */}
